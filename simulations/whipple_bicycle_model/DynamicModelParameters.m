...
%% Equations
%Taken from the paper "Linearized dynamics equations for the balance and
%steer of a bicycle a benchmark and review" A copy is available in the
%zipped folder.
...
C1=[C1fifi C1fidelta; C1deltafi C1deltadelta]; %A27
 ...
 %% State space model of the whipple model can be view in 
 %"A Robust Two-stage Active Disturbance Rejection Control for the
 % Stabilization of a Riderless Bicycle" located in the same map
 ...
 sys_Whipple_cont=ss(A,B,C,D);
 sys_Whipple_dis=c2d(sys_Whipple_cont,Ts);
