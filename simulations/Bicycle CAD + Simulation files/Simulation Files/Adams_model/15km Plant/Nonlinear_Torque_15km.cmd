...
!
marker create  &
   marker_name = .Bike.Frame_1.TorqueTEST_stator_attach_J  &
   adams_id = 10097  &
   location = 0.5403151991, 0.0, -0.5968163043  &
   orientation = 270.0d, 178.0d, 180.0d
!
...
!
marker create  &
   marker_name = .Bike.Fork_2.TorqueTEST_rotor_attach_J  &
   adams_id = 10085  &
   location = -2.5249999693E-02, 2.5250000035E-02, -0.2289999999  &
   orientation = 91.83730981d, 180.0d, 0.0d
!
...
!
file parasolid read  &
   file_name = "Nonlinear_Torque_15km.xmt_txt"  &
   model_name = .Bike
!
geometry attributes  &
...
variable modify  &
   ...
   string_value = ".Bike.Fork_2.TorqueTEST_rotor_attach_J"
!
variable modify  &
   variable_name = .Bike.TorqueMotor.stator_attachment  &
   string_value = ".Bike.Frame_1.TorqueTEST_stator_attach_J"
!
variable modify  &
...
variable modify  &
   ...
   object_value = .Bike.Fork_2.TorqueTEST_rotor_attach_J
!
variable modify  &
   variable_name = .Bike.TorqueMotor.mar_joi_J  &
   object_value = .Bike.Frame_1.TorqueTEST_stator_attach_J
!
variable modify  &
